...
Здесь - подробное описание первого проекта. Yf эту страницу можно попасть только со страницы Our Projects.
...
Здесь даны контакты для связи с компанией, а также приведена На эту страницу ведет ссылка Contacts в header и footer. 
